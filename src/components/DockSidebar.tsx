      ...
      <div className={`${fullSidebar ? 'bg-white border-r border-gray-200 rounded-none h-full' : 'bg-white/30 backdrop-blur-2xl border border-white/40 rounded-3xl'} shadow-2xl overflow-hidden`}>
        {!dockExpanded ? (
          <div className="p-3 space-y-3">
            ...
            <button onClick={() => setDockExpanded(true)} className="w-8 h-8 bg-navy-500/10 hover:bg-navy-500/20 rounded-2xl flex items-center justify-center transition-all duration-200 group shadow-lg hover:shadow-xl">
